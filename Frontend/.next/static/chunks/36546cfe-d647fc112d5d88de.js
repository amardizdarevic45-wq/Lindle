"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[315],{3871:function(e,t,r){r.d(t,{V:function(){return GoogleAuthProvider},o:function(){return getAuth}});var i,n=r(8745),s=r(3991),a=r(44),o=r(6914),l=r(5538);function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new n.LL("auth","Firebase",_prodErrorMap()),c=new o.Yd("@firebase/auth");function _logError(e,...t){c.logLevel<=o.in.ERROR&&c.error(`Auth (${s.Jn}): ${e}`,...t)}/**
 * @license
